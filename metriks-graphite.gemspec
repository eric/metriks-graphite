...
Gem::Specification.new do |s|
  ...
  ## as you like.
  s.summary     = "Graphite reporter for metriks"
  s.description = "Graphite reporter for metriks"
  ...
  s.homepage = 'https://github.com/eric/metriks-graphite'
